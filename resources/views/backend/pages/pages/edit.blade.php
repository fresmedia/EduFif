                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select class="form-control custom-select select2" id="types" name="article_type_id" style="width: 100%;">
                                    ...
                                    <select class="form-control custom-select select2" id="types" name="advertisement_ids[]"
                                        ...
                                        @foreach ($advertisements as $advertisement)
                                            <option value="{{ $advertisement->id }}"
                                                {{ App\Models\Page::checkHasAdvertisement($page->id, $advertisement->id) ? 'selected' : null }}
                                            >

            ...
            <div class="col-md-12 mt-5">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('diaspora.category.show', $parent_main->slug) }}">{{ $parent_main->name }}</a></li>
                  <li class="breadcrumb-item"><a href="{{ route('diaspora.category.child1.show', [$parent_main->slug, $parent->slug]) }}">{{ $parent->name }}</a></li>
